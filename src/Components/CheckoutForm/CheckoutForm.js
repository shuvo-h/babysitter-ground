...
const CheckoutForm = ({payment, bookingId}) => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            />
            {
                processing ? <span>Processing..</span> : <button className='bg-blue-300 px-4 py-1 font-bold rounded text-green-700 hover:bg-green-200 block mx-auto my-8 ' type="submit" disabled={!stripe || success}> Pay ${payment}</button>
            }
